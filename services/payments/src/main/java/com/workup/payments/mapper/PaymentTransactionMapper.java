...
public class PaymentTransactionMapper {
    ...
    public static PaymentTransactionDTO mapToPaymentTransactionDTO(PaymentTransaction paymentTransaction) {
    ...
    public static List<PaymentTransactionDTO> mapToPaymentTransactionDTOs(List<PaymentTransaction> paymentTransactions) {
