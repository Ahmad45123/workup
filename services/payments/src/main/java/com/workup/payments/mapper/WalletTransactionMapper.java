...
public class WalletTransactionMapper {
    ...
    public static WalletTransactionDTO mapToWalletTransactionDTO(WalletTransaction walletTransaction) {
    ...
    public static List<WalletTransactionDTO> mapToWalletTransactionDTOs(List<WalletTransaction> walletTransactions) {
