...
public class RequestContractTerminationCommand
  ...
  public ContractTerminationResponse Run(ContractTerminationRequest request) {
    ...
    List<TerminationRequest> existedRequests =
        terminationRequestRepository.findByRequesterIdAndContractIdAndStatus(
            request.getUserId(), request.getContractId(), TerminationRequestStatus.PENDING);
