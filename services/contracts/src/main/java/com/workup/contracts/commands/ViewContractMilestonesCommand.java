...
public class ViewContractMilestonesCommand extends  ContractCommand<ViewContractMilestonesRequest, ViewContractMilestonesResponse> {

  @Override
  public ViewContractMilestonesResponse Run(ViewContractMilestonesRequest request) {
    List<ContractMilestone> milestones = contractMilestoneRepository.findByContractId(request.getContractId());

    @SuppressWarnings("unchecked")
    List<Milestone> contractMilestones = (List<Milestone>) milestones.stream()
