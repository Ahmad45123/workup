...
public class GetFreelancerEducationsCommand extends UserCommand<GetFreelancerEducationsRequest, GetFreelancerEducationsResponse> {
    @Override
    public GetFreelancerEducationsResponse Run(GetFreelancerEducationsRequest request) {
        ...
        return GetFreelancerEducationsResponse.builder().withSuccess(true).withEducations(educations).build();
    }
}
