...
public class GetFreelancerAchievementsCommand extends UserCommand<GetFreelancerAchievementsRequest, GetFreelancerAchievementsResponse> {
    @Override
    public GetFreelancerAchievementsResponse Run(GetFreelancerAchievementsRequest request) {
        ...
        return GetFreelancerAchievementsResponse.builder().withSuccess(true).withAchievements(achievements).build();
    }
}
