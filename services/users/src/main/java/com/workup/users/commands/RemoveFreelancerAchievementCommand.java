...
public class RemoveFreelancerAchievementCommand extends UserCommand<RemoveFreelancerAchievementRequest, RemoveFreelancerAchievementResponse> {
    @Override
    public RemoveFreelancerAchievementResponse Run(RemoveFreelancerAchievementRequest request) {
        ...
        freelancer.getAchievements().removeIf(achievement -> achievement.getId().toString().equals(request.getAchievementId()));
        deleteAchievement(request.getAchievementId());
        freelancerRepository.save(freelancer);
        return RemoveFreelancerAchievementResponse.builder().withSuccess(true).withFreelancer(freelancer).build();
    }
