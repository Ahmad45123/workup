...
public class RemoveFreelancerExperienceCommand extends UserCommand<RemoveFreelancerExperienceRequest, RemoveFreelancerExperienceResponse> {
    @Override
    public RemoveFreelancerExperienceResponse Run(RemoveFreelancerExperienceRequest request) {
        ...
        freelancer.getExperiences().removeIf(experience -> experience.getId().toString().equals(request.getExperience_id()));
        deleteExperience(request.getExperience_id());
        freelancerRepository.save(freelancer);
        return RemoveFreelancerExperienceResponse.builder().withSuccess(true).withFreelancer(freelancer).build();
    }
