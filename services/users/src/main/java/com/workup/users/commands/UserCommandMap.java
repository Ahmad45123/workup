...
@Component
public class UserCommandMap extends CommandMap<UserCommand<? extends CommandRequest, ? extends CommandResponse>> {
    @Autowired
    ...
    @Override
    public void setupCommand(UserCommand<? extends CommandRequest, ? extends CommandResponse> command) {
