...
public class FreelancerGetProfileCommand
    ...
    public FreelancerGetProfileResponse Run(FreelancerGetProfileRequest request) {
        ...
        if (!freelancer.isPresent()) {
            return FreelancerGetProfileResponse.builder().withStatusCode(HttpStatusCode.INTERNAL_SERVER_ERROR).build();

        }

        return FreelancerGetProfileResponse.builder().withStatusCode(HttpStatusCode.OK).withBirth_date(freelancer.get().getBirthdate())
