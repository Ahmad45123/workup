...
// milestone to the IN_REVIEW state. The client will then choose the next state the milestone should
// progress
// to from two possible choices(the first choice is back to the IN_PROGRESS state if they want
// changed
// to be made, otherwise the choice is to the ACCEPTED state if they accept the work done for this
// milestone).
// if a milestone is ACCEPTED, it cannot be evaluated or progressed again, except to the PAID state
// by the
